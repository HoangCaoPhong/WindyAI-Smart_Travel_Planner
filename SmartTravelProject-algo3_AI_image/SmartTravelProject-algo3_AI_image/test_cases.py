...
class TestVietnameseLocationRecognition(unittest.TestCase):
    ...
    def create_dummy_image(self, size=(224, 224), mode="RGB"):
        ...
        if mode == "L":
            ...
            return Image.new(mode, size, color=(128, 128, 128, 255))
        else:
    ...
    def test_18_predict_invalid_bytes_raises_error(self):
        ...
        # Should raise either UnidentifiedImageError or OSError
    ...
    def test_19_preprocess_transform_output_shape(self):
        ...
        # Verify normalized range (approximately)
        self.assertGreater(tensor.max().item(), -3.0)
        self.assertLess(tensor.min().item(), 3.0)
